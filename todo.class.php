...
class ToDo{
	...
	*/
	...
	public static function delete($id){
		...
		mysql_query("DELETE FROM bf_todo WHERE id=".$id);
	...
	*/
	...
	public static function rearrange($key_value){
		...
		mysql_query("	UPDATE bf_todo SET position = CASE id
						".join($strVals)."
						ELSE position
						END");
	...
	*/
	...
	public static function createNew($text){
		...
		$posResult = mysql_query("SELECT MAX(position)+1 FROM bf_todo");
		...
		mysql_query("INSERT INTO bf_todo SET text='".$text."', position = ".$position);
